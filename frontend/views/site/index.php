    ...
    <div class="container-fluid">
        <div class="header-body">
            ...
            <div class="row justify-content-around topheader">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span style="color: #32325d; background: url(/theme/dist/img/link_hover_tolqin.svg); padding-bottom: 3px;" class="h4 mb-0">
                                            <?= prettyNumber(\common\models\TaskEmp::find()->where(['reciever_id'=>Yii::$app->user->id])->andWhere(['>','created','2022-09-01'])->count('reciever_id')) ?> та</span>
                                    </div>
                                </div>
                ...
                <?php $status = \common\models\Status::find()->all();
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <br />
                                        <span style="color: #32325d; background: url(/theme/dist/img/link_hover_tolqin.svg); padding-bottom: 3px;" class="h4 mb-0">
                                            <?= prettyNumber(\common\models\TaskEmp::find()->where(['reciever_id'=>Yii::$app->user->id])->andWhere(['status'=>$item->id])->andWhere(['>','created','2022-09-01'])->count('reciever_id')) ?> та</span>
                                    </div>
                                </div>
