...
class AppealRegisterSearch extends AppealRegister
{
    ...
    public function search($params)
    {
        ...
        $query = AppealRegister::find()->where(['appeal_register.company_id'=>$user->company_id])->innerJoin('appeal','appeal.id=appeal_register.appeal_id')->orderBy(['appeal_register.status'=>SORT_ASC,'deadtime'=>SORT_ASC]);
