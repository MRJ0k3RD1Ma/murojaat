...
class AppealRegisterMySearch extends AppealRegister
{
    ...
    {
        return [
            [['id', 'appeal_id', 'rahbar_id','question_id','gender', 'ijrochi_id', 'parent_bajaruvchi_id', 'deadline', 'status', 'control_id','region_id','district_id','village_id','company_id', 'answer_send', 'nazorat', 'takroriy', 'takroriy_id'], 'integer'],
    ...
    public function search($params)
    {
        ...
        ->orWhere(['ijrochi_id'=>$user->id])->orWhere(['rahbar_id'=>$user->id])->orderBy(['appeal_register.status'=>SORT_ASC,'appeal_register.deadtime'=>SORT_ASC]);
