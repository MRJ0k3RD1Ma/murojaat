                ...
                <a href="#">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">Уйма-уй юриш орқали ўтказиладиган ўрганиш бўйича САВОЛНОМА (Оққўрғон тажрибаси)
                                    </h5>
                                    <br />
                                    <span style="color: #32325d; background: url(/theme/dist/img/link_hover_tolqin.svg); padding-bottom: 3px;" class="h4 mb-0">Умумий <b><?= prettyNumber(0) ?></b> та сўровнома</span>
                                </div>
                ...
                <a href="#">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">Объектда ўтказиладиган ўрганиш бўйича САВОЛНОМА (Оққўрғон тажрибаси)
                                    </h5>
                                    <br />
                                    <span style="color: #32325d; background: url(/theme/dist/img/link_hover_tolqin.svg); padding-bottom: 3px;" class="h4 mb-0">Умумий <b><?= prettyNumber(0) ?></b> та сўровнома</span>
                                </div>
