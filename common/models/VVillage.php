...
class VVillage extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['gender','is_want_credit','has_cl_problem', 'want_econom_energy', 'person_birthday', 'migrant', 'home_status_id','road', 'want_subsidy','address', 'person_name','person_phone',],'required'],
